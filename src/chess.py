...
class Chess:
	...
	def get_leaderboard(
		...
		return self._get("/v1/leaderboard", params=params)
	...
	def get_forum_topics(
		...
		params = {
			...
			"page": page,
			"topicsPerPage": per_page
		}
		return self._get("/v1/forums/topics", params=params)
	...
	def get_topic_comments(
		...
		return self._get("/v1/forums/comments", params=params)
	...
	def get_news(self, page: int = 0, per_page: int = 20) -> dict:
		...
		return self._get("/v1/news", params=params)
	...
	def get_news_comments(
		...
		return self._get(
			f"/v1/news/{news_id}/comments", params=params)
	...
	def get_articles(self, page: int = 0, per_page: int = 20) -> dict:
		...
		return self._get("/v1/articles/list", params=params)
	...
	def get_article_comments(
		...
		return self._get(
			f"/v1/articles/{article_id}/comments", params=params)
	...
	def get_games(self, start: int = 0, limit: int = 10) -> dict:
		...
		return self._get("/gamelist/top", base=self.web_api, params=params)
	...
	def get_game_chat(self, game_id: str, limit: int = 50) -> dict:
		params = {"limit": limit}
		return self._get(
			f"/chat/game/live/{game_id}/observers/messages",
			base=self.web_api,
			params=params)
